...
from PySide6.QtWidgets import (QApplication, QHBoxLayout, QHeaderView, QLabel,
                               ...
                               QSizePolicy, QSlider, QSpacerItem, QTableWidget,
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalSpacer = QSpacerItem(
            20, 10, QSizePolicy.Preferred, QSizePolicy.Minimum
        )
        ...
        self.optDir.setObjectName("optDir")
    ...
    def retranslateUi(self, Form):
        ...
        self.add.setText(QCoreApplication.translate("Form", "+", None))
        self.sub.setText(QCoreApplication.translate("Form", "-", None))
        ___qtablewidgetitem = self.names.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("Form", "names", None))
        self.label_2.setText(
            QCoreApplication.translate("Form", "\u8f93\u51fa\u6587\u4ef6\u5939", None)
        )
        self.optDir.setText(QCoreApplication.translate("Form", "imgs", None))
        self.start.setText(QCoreApplication.translate("Form", "\u542f\u52a8", None))
        self.label_3.setText(
            QCoreApplication.translate("Form", "\u5b57\u4f53\u5927\u5c0f", None)
        )
        self.sizeLabel.setText(QCoreApplication.translate("Form", "350", None))
        self.label.setText(QCoreApplication.translate("Form", "Log", None))
